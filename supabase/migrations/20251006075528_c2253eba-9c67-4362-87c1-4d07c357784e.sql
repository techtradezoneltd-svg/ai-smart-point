-- Update the first user setup function to recognize admin@admin.com as admin
...
BEGIN
  ...
  IF NEW.email = 'admin@admin.com' OR NEW.email = 'krwibutso5@gmail.com' OR NEW.email = 'kevllatest@gmail.com' THEN
